        ...
        <div class="col-md-8 col-md-offset-2">
            <color-box title="{{ $loan->fromr->name . ' ' . $loan->item }}" color="info">
                {!! Form::open(['method' => 'POST', 'route' => 'loans.pay']) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($loan->q1 == 0 && $loan->status != 'solicitado' && $loan->status != 'aceptado' && $loan->from != auth()->user()->store_id)
                                        {!! Field::number('q1', ['tpl' => 'loans/input', 'min' => '0']) !!}
                                ...
                                <td>
                                    ...
                                    <h4><B>Cantidad:</B></h4>
                                    @if ($loan->q1 >= 1 && $loan->q2 == 0 && $loan->from != auth()->user()->store_id)
                                        {!! Field::number('q2', ['tpl' => 'loans/input', 'min' => '0']) !!}
                                ...
                                <td>
                                    ...
                                    <h4><B>Cantidad:</B></h4>
                                    @if (($loan->q2 >= 1 && $loan->q3 == 0 ) && $loan->from != auth()->user()->store_id)
                                        {!! Field::number('q3', ['tpl' => 'loans/input', 'min' => '0']) !!}
                    ...
                    @if ($loan->from != auth()->user()->store_id)
