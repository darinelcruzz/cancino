...
export default {
    ...
    updated() {
        this.$root.$emit('employeesum' + this.employee, {index: this.week, amount: this.amount})
        this.$root.$emit('weeksum' + this.week, {index: this.employee, amount: this.amount})
    },
    created() {
