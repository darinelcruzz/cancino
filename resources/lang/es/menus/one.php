...
return [
    ...
    'Shoppings' => [
        'title' => 'Compras',
        'icon' => 'fa fa-archive',
        'label' => ['danger' => undefinedShoppings() > 0 ? undefinedShoppings(): '', 'warning' => pendingShoppings() > 0 ? pendingShoppings() : '', 'primary' => printedShoppingsStores() > 0 ? printedShoppingsStores() : ''],
